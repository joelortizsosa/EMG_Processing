...
% Proceso para centrar las señales, restando la media a cada échantionage
...
%Filtrado de las señales, utilizando la tecnica Wavelet, para la extraccion
%del ruido.

%señales observadas, a partir de las cuales se procedera aencontrar las
%fuentes
...
% plot(rms_source1,'r');
 ...
 %Ahora calculamos la RMS de estas señales
